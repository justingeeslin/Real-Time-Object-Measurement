...
@pytest.mark.parametrize(
    "image_path, expected_count, expected_w_cm, expected_h_cm, tol_cm",
    [
        ("../1.jpg", 2, 9.0, 5.0, 1.0),  # adjust tol if your lighting/edges vary
    ],
)
def test_1jpg_two_objects_about_9x5(image_path, expected_count, expected_w_cm, expected_h_cm, tol_cm):
